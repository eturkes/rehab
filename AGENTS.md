...
- Long horizon → decompose into steps across unlimited fresh sessions, tracked in `docs/roadmap.md`; split work across sessions to preserve thoroughness.
