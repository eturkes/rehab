...
docs/project-reference.md §3.  Notable choices: dressing/bathing/grooming/feeding at >=2 (independent with
...
(verified; see docs/project-reference.md §0b).  Descriptive in-sample SHAP drivers rank what predicts each
...
# no human assistance) per the SCIM-III rubric.  Ordered by domain for display.  See
