...
- Three reversion denominators, all live: `reverted_of_peaked` (per grade, conditional on crossing), `overall.fell_back` 7.7% = 53/686 = any drop from peak incl. non-crossers (= the figure's red annotation; 40 crossings + the 13 non-crossers that end below admission), `rate_ended_below` 1.9% = 13/686. Never mix them in one claim.
